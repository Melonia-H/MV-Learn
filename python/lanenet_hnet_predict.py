...
def predict_lanenet(gt_image, lanenet_weights):
    ...
    with tf.Session(config=sess_config) as sess:
        ...
        print(predict_binary.shape)
        print(predict_lanenet.shape)
        print(predict_instance.shape)

        cv2.imwrite('./out/predict_binary.png', predict_binary)
        cv2.imwrite('./out/predict_lanenet.png', predict_lanenet)
        cv2.imwrite('./out/predict_instance.png', predict_instance)
    ...
    with tf.Session(config=sess_config) as sess:
        ...
        for i in range(len(lanes_pts)):
            ...
            for j in range(coefficient_back.shape[1]):
                color = color_map[i]
                cv2.circle(image, (coefficient_back[0][j], coefficient_back[1][j]), 1, (255,0,0), 1)
...
if __name__ == '__main__':
    ...
    image_path = '/home/maohui/all_files/a_programs/TestCar/laneDetect/programs/tensorflow/test/testTensorC/data/0000.png'
    lanenet_weights = '/home/maohui/all_files/a_programs/TestCar/laneDetect/programs/tensorflow/test/testTensorC/tusimple_model/tusimple_lanenet/tusimple_lanenet_enet_2019-06-26-14-54-26.ckpt-21000'
    hnet_weights = '/home/maohui/all_files/a_programs/TestCar/laneDetect/programs/tensorflow/test/testTensorC/tusimple_model/hnet/hnet-2000'
    predict(image_path, lanenet_weights, hnet_weights)
